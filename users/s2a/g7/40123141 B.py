...
cgo = cango("plotarea")
#決定(0，0)點位置
cgo.setWorldCoords(-150, -100, 550, 500) 
...
# basic1 轉 120 度
    ...
    basic8 = cmbr.dup()
    basic8.rotate(60)
    basic8.translate(20,80)

    basic9 = cmbr.dup()
    basic9.rotate(0)
    basic9.translate(20+20*math.sin(60*deg),80-20*math.cos(60*deg))
    
    basic10 = cmbr.dup()
    basic10.rotate(300)
    basic10.translate(20+20*math.sin(60*deg),60-20*math.cos(60*deg))
    ...
    basic12 = cmbr.dup()
    basic12.rotate(90)
    basic12.translate(0, 0)
    
    basic13 = cmbr.dup()
    basic13.rotate(120)
    basic13.translate(20,0)
    
    basic14 = cmbr.dup()
    basic14.rotate(180)
    basic14.translate(20+20*math.sin(60*deg),20*math.cos(60*deg))

    basic15 = cmbr.dup()
    basic15.rotate(60)
    basic15.translate(20,40)
